...
if choiceint == 4:
    ...
    decimalnum1int = int(decimalnum1)
    while decimalnum1int != 0:
        decimalnum1left = decimalnum1int % 16
        decimalnum1int = decimalnum1int // 16
        binarylist.append(decimalnum1left)
    binarylist.reverse()
        ...
        if binarylist[i] > 9 :
            if binarylist[i] == A:
               binarylist[i] = "A"
                ...
                binarylist[i] = "F"
    for c in binarylist:
        binaryliststr = binaryliststr + str(c)
    print("Your Decimal Number in Hexadecimal is",binaryliststr)
